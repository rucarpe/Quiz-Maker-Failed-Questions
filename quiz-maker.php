 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '21.7.9' );
define( 'AYS_QUIZ_VERSION', '21.7.9' );
...
<!--                        <li class="modile-ddmenu-xs take_survay"><a class="ays-btn" href="http://bit.ly/2tLbooO" target="_blank">Take a survey</a></li>-->
                        <li class="modile-ddmenu-lg"><a class="ays-btn" href="https://quiz-plugin.com/upcoming-quiz-maker-features" target="_blank"><?php echo __( "Upcoming Features (Vote)", AYS_QUIZ_NAME ); ?></a></li>
                        ...
                        <li class="modile-ddmenu-md">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                <li><a class="ays-btn" href="https://quiz-plugin.com/wordpress-quiz-plugin-pro-demo/" target="_blank"><?php echo __( "Demo", AYS_QUIZ_NAME ); ?></a></li>
                                 <li><a class="ays-btn" href="https://quiz-plugin.com/upcoming-quiz-maker-features" target="_blank"><?php echo __( "Upcoming Features (Vote)", AYS_QUIZ_NAME ); ?></a></li>
