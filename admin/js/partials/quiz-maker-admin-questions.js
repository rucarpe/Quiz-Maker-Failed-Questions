    ...
    $(document).ready(function(){
        ...
        $(document).find('#ays-type').on('change', function(e){
            ...
            if($(this).val() == 'date'){
                ...
                var fillInBlankTypeText = "<div class='ays_quiz_small_hint_text_for_message_variables' style='cursor:default;'>"+ quizLangObj.fillInBlankTypeSlugText + "</div>";
                ...
                var addAnswerHTML = '<a href="javascript:void(0)" class="ays-add-fill-in-blank-answer"><span class="ays-add-fill-in-blank-answer-span" style="margin-right: 10px;">'+
                    quizLangObj.answer +
                    '</span><i class="ays_fa ays_fa_plus_square" aria-hidden="true"></i>'+
                '</a>'+fillInBlankTypeText;
