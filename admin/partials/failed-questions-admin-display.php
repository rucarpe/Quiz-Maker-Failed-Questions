...
<div class="wrap">
    ...
    <div class="ays-quiz-heading-box ays-quiz-unset-float">
        <div class="ays-quiz-wordpress-user-manual-box">
            <a href="https://rucarpe.com/docs/quiz-maker-failed-questions" target="_blank"><?php echo __("View Documentation", "quiz-maker-failed-questions"); ?></a>
        </div>
    </div>
    ...
    <div id="tab1" class="ays-quiz-tab-content ays-quiz-tab-content-active">
        <form id="ays-failed-questions-settings-form">
            ...
            <div class="form-group row">
                <div class="col-sm-12">
                    <h3><?php echo __('Instructions for use', 'quiz-maker-failed-questions'); ?></h3>
                    <ol>
                        <li><?php echo __('Add the shortcode <code>[quiz_maker_failed_questions]</code> to any page where you want to display the failed questions menu.', 'quiz-maker-failed-questions'); ?></li>
                        <li><?php echo __('When users complete regular Quiz Maker quizzes, their failed questions will be automatically recorded.', 'quiz-maker-failed-questions'); ?></li>
                        <li><?php echo __('Users can then practice these failed questions using the menu generated by the shortcode.', 'quiz-maker-failed-questions'); ?></li>
                        <li><?php echo __('Once a user answers a question correctly the specified number of consecutive times, it will be removed from their failed questions list.', 'quiz-maker-failed-questions'); ?></li>
                    </ol>
                </div>
            </div>
