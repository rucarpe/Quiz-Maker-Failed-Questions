<?php
    ...
    $options2 = ($actions->ays_get_setting('options') === false) ? array() : json_decode( $actions->ays_get_setting('options'), true);
    ...
    $question_types = array(
        ...
        "custom"            => __("Info (Banner)", $this->plugin_name),
    ...
    $question_default_tags = isset($options['question_default_tags']) && $options['question_default_tags'] != '' ? stripslashes(esc_attr($options['question_default_tags'])) : "";
    $question_tags = Quiz_Maker_Data::get_question_tags( true );
...
//    $show_result_report = ( isset( $options['ays_show_result_report'] ) && $options['ays_show_result_report'] != 'on' ) ? 'off' : 'on';
    ...
    $keyword_default_max_value = (isset($options['keyword_default_max_value']) && $options['keyword_default_max_value'] != '') ? absint(intval($options['keyword_default_max_value'])) : 26;
    ...
    $quiz_flash_card_enable_introduction = (isset( $options2['quiz_flash_card_enable_introduction'] ) && $options2['quiz_flash_card_enable_introduction'] == 'on') ? 'on' : 'off';
    $quiz_flash_card_introduction = (isset( $options2['quiz_flash_card_introduction']) && $options2['quiz_flash_card_introduction'] != '') ? htmlspecialchars_decode($options2['quiz_flash_card_introduction']) : '';
            ...
            <div class="ays-quiz-tabs-wrapper">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <label for="ays_quiz_question_tags">
                                    <?php echo __( "Questions default tags", $this->plugin_name ); ?>
                                    <a class="ays_help" data-toggle="tooltip" title="<?php echo __('You can choose default question tags which will be selected in the Add new question page.',$this->plugin_name)?>">
                                        <i class="ays_fa ays_fa_info_circle"></i>
                                    </a>
                                </label>
                            </div>
                                ...
                                <select id="ays_quiz_question_tags" multiple name="ays_quiz_question_tags[]">
                                     <?php
                                        ...
                                        foreach ($question_tags as $question_tag) {
                                            ...
                                            $tag_ids = null;
                                            if( isset( $question_default_tags ) && $question_default_tags != ""){
                                                $tag_ids = explode(',', $question_default_tags);
                                            }

                                            $checked = "";
                                            if( !is_null($tag_ids) && !empty($tag_ids) ){
                                                if(in_array( intval($question_tag['id']) , $tag_ids)){
                                                    $checked = "selected";
                                                }
                                            }

                                            echo "<option value='" . $question_tag['id'] . "' " . $checked . ">" . stripslashes($question_tag['title']) . "</option>";
                                            $cat++;
                                        }
                                    ?>
                                </select>
                ...
                <div id="tab2" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab2') ? 'ays-quiz-tab-content-active' : ''; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9 ays_toggle_parent">
                                        ...
                                        <label class="ays_quiz_loader" style="display:inline-block;">
                                            ...
                                            <span><?php echo __('Active Period',$this->plugin_name)?></span>
                                        </label>
                                        <a class="ays_help" style="font-size:15px;" data-toggle="tooltip" data-html="true"
                                            title="<?php
                                                ...
                                                "<ul style='list-style-type: circle;padding-left: 20px;'>".
                                                    ...
                                                    "<li>". __('Active Period - By enabling this option, the quiz will be available during your chosen period of time. You can set the active period duration by Day, Month or Year. This option is (designed for logged-in users).',$this->plugin_name) ."</li>".
                                                "</ul>";
                                            ?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                        ...
                                        <div class="ays_toggle_target_2" style="<?php echo $paypal_payment_terms == "subscribtion" ? "display:block;" : "display:none;"; ?>">
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                                                    <label class="form-check-label" for="ays-subscribtion-duration"> <?php echo __('Active Period duration', $this->plugin_name); ?> </label>
                                                </div>
                    ...
                    <?php 
                        if(1 == 0):
                    ?>
                    <!-- PayPal/Stripe Pro Features | Start -->                
                    <fieldset>
                        <legend>
                            <img class="ays_integration_logo" src="<?php echo AYS_QUIZ_ADMIN_URL; ?>/images/integrations/paypal_logo.png" alt="">
                            <h5><?php echo __('PayPal',$this->plugin_name)?></h5>
                        ...
                        <div class="form-group row" style="padding:0;margin:0;">
                            ...
                            <div class="col-sm-12 only_pro ays-quiz-margin-top-20" style="padding:20px;">
                                ...
                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-business&utm_campaign=paypal-integration" target="_blank" class="ays-quiz-new-upgrade-button-link">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row" style="padding:0;margin:0;">
                            <div class="col-sm-12 only_pro" style="padding:20px;">
                                ...
                                <a href="https://ays-pro.com/wordpress/quiz-maker?utm_source=dashboard&utm_medium=quiz-business&utm_campaign=stripe-integration" target="_blank" class="ays-quiz-new-upgrade-button-link">
                                    <div class="ays-quiz-new-upgrade-button-box">
                                        <div>
                                            <img src="<?php echo AYS_QUIZ_ADMIN_URL.'/images/icons/locked_24x24.svg'?>">
                                            <img src="<?php echo AYS_QUIZ_ADMIN_URL.'/images/icons/unlocked_24x24.svg'?>" class="ays-quiz-new-upgrade-button-hover">
                    ...
                    <hr/>
                    <!-- PayPal/Stripe Pro Features | End -->
                    <?php 
                        endif;
                    ?>
                    <fieldset>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label for="ays_zapier_hook">
                                            <?php echo __('Zapier Webhook URL', $this->plugin_name); ?>
                                        </label>
                                    </div>
                                    <div class="col-sm-9">
                                        <input type="text"
                        ...
                        <blockquote>
                            <ul class="ays-quiz-general-settings-blockquote-ul">
                                <li>
                                    <?php
                                        echo sprintf(
                                            __( '%s From %s', $this->plugin_name ) . ' - ' . __( 'Specify the start date to display the leaderboard (e.g. 2021-01-01 00:00:00)', $this->plugin_name ),
                                            '<b>',
                                            '</b>'
                                        );
                                    ?>
                                ...
                                <li>
                                    <?php
                                        echo sprintf(
                                            __( '%s To %s', $this->plugin_name ) . ' - ' . __( 'Specify the end date to display the leaderboard
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                                    <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                        <a href="https://youtu.be/YVp2KpsOAOc" target="_blank">
                                            <?php echo __("How to set User Page Settings Shortcode - video", $this->plugin_name); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <li>
                                    ...
                                    <ul class='ays-quiz-general-settings-ul'>
                                        ...
                                        <li>
                                            <?php
                                                echo sprintf(
                                                    __( '%s category %s', $this->plugin_name ) . ' - ' . __( 'If you set the method as Category, it will show all questions assigned to the given category.
                                                    ', $this->plugin_name ),
                                                    '<b>',
                                                    '</b>'
                                                );
                                ...
                                <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                                    <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                        <a href="https://youtu.be/Eg7wzKTSsEA" target="_blank">
                                            <?php echo __("How to set Recent Quizzes Settings shortcode - video", $this->plugin_name); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row" style="padding:0px;margin:0;">
                            <div class="col-sm-12">
                                <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                                    <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                        <a href="https://youtu.be/ZbP1V2UXD-o" target="_blank">
                                            <?php echo __("How to set the Display the sum of the quiz points shortcode - video", $this->plugin_name); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row" style="padding:0px;margin:0;">
                            <div class="col-sm-12">
                                <div class="ays-quiz-heading-box ays-quiz-unset-float ays-quiz-unset-margin">
                                    <div class="ays-quiz-wordpress-user-manual-box ays-quiz-wordpress-text-align">
                                        <a href="https://youtu.be/kbgfDnJ5t_o" target="_blank">
                                            <?php echo __("How to set Show Quiz Orders shortcode - video", $this->plugin_name); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="tab4" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab4') ? 'ays-quiz-tab-content-active' : ''; ?>">
                    ...
                    <fieldset>
                        ...
                        <p class="vmessage">
                            <strong>
                                <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%question_category_name_{question_cat_ID}%%" />
                            </strong>
                            <span> - </span>
                            <span style="font-size:18px;">
                                <?php echo __( "It displays the Question Category Name by ID.", $this->plugin_name); ?>
                            </span>
                        </p>
                        <p class="vmessage">
                            <strong>
                                <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%user_points_by_question_category_{question_cat_ID}%%" />
                            </strong>
                            <span> - </span>
                            <span style="font-size:18px;">
                                <?php echo __( "It displays the points the user got by answering the questions of the given Question Category ID.", $this->plugin_name); ?>
                            </span>
                        </p>
                        <p class="vmessage">
                            <strong>
                                <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%user_max_point_by_question_category_{question_cat_ID}%%" />
                            </strong>
                            <span> - </span>
                            <span style="font-size:18px;">
                                <?php echo __( "It displays the maximum possible points by Question Category.", $this->plugin_name); ?>
                            </span>
                        </p>
                        <p class="vmessage">
                            <strong>
                                <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%question_category_displayed_questions_count_{question_cat_ID}%%" />
                            </strong>
                            <span> - </span>
                            <span style="font-size:18px;">
                                <?php echo __( "It displays the number of those questions that were displayed to the user from the particular question category.", $this->plugin_name); ?>
                            </span>
                        </p>
                    ...
                    <fieldset>
                        ...
                        <p class="vmessage">
                            <strong>
                                <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%avg_rate_stars_with_icons%%" />
                            </strong>
                            <span> - </span>
                            <span style="font-size:18px;">
                                <?php echo __( "The average rate of the quiz of all time displayed with star icons. Note: This message variable will not work in the email fields.", $this->plugin_name); ?>
                            </span>
                        </p>
                        <p class="vmessage">
                            <strong>
                        ...
                        <p class="vmessage">
                            <strong>
                                <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%quiz_image%%" />
                            </strong>
                            <span> - </span>
                            <span style="font-size:18px;">
