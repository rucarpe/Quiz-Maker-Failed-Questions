    ...
    <div class="form-group row ays_toggle_parent">
        ...
        <div class="col-sm-8 ays_toggle_target ays_divider_left <?php echo (isset($options['user_mail']) && $options['user_mail'] == 'on') ? '' : 'display_none'; ?>">
            ...
            <div class="form-group row ays_toggle_parent">
                ...
                <div class="col-sm-1">
                    <input type="checkbox" class="ays-enable-timerl ays_toggle_checkbox" id="ays_send_results_user"
                   name="ays_send_results_user"
                   value="on" <?php echo $send_results_user ?>/>
                </div>
                <div class="col-sm-8 ays_toggle_target <?php echo $send_results_user ? "" : "display_none"; ?>">
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <label for="ays_quiz_send_results_user_without_img">
                                <?php echo __('Send results without images',$this->plugin_name); ?>
                                <a  class="ays_help" data-toggle="tooltip" title="<?php echo __('Enable this option and the images of questions and answers will not be sent to the user with the report table.',$this->plugin_name); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                        <div class="col-sm-8">
                            <input type="checkbox" class="ays-enable-timerl" id="ays_quiz_send_results_user_without_img" name="ays_quiz_send_results_user_without_img" value="on" <?php echo $quiz_send_results_user_without_img ? 'checked' : ''; ?> />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <label class="ays_quiz_loader">
                        ...
                        <span for="ays_cert_orientation_l"><?php echo __('Landscape',$this->plugin_name)?></span>
                    </label>
                    <label class="ays_quiz_loader">
                        ...
                        <span for="ays_cert_orientation_p"><?php echo __('Portrait',$this->plugin_name)?></span>
                    </label>
                </div>
            </div>
            <hr>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="ays-certificate-frames">
                        ...
                        <?php
                        for($frame_ind = 1; $frame_ind <= 12; $frame_ind++):
                    ...
                    <div class="ays-certificate-frames">
                        <?php
                        for($frame_ind = 1; $frame_ind <= 10; $frame_ind++):
    ...
    <div class="form-group row ays_toggle_parent">
        ...
        <div class="col-sm-8 ays_toggle_target ays_divider_left" style="<?php echo (isset($options['admin_mail']) && $options['admin_mail'] == "on") ? "" : "display:none;" ?>">
            ...
            <div class="form-group row ays_toggle_parent">
                ...
                <div class="col-sm-1">
                    <input type="checkbox" class="ays-enable-timerl ays_toggle_checkbox" id="ays_send_results_admin"
                           name="ays_send_results_admin" value="on" <?php echo $send_results_admin; ?>/>
                </div>
                <div class="col-sm-6 ays_toggle_target <?php echo $send_results_admin ? "" : "display_none"; ?>">
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <label for="ays_quiz_send_results_admin_without_img">
                                <?php echo __('Send results without images',$this->plugin_name); ?>
                                <a  class="ays_help" data-toggle="tooltip" title="<?php echo __('Enable this option and the images of questions and answers will not be sent to the admin with the report table.',$this->plugin_name); ?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                        <div class="col-sm-8">
                            <input type="checkbox" class="ays-enable-timerl" id="ays_quiz_send_results_admin_without_img" name="ays_quiz_send_results_admin_without_img" value="on" <?php echo $quiz_send_results_admin_without_img ? 'checked' : ''; ?> />
                        </div>
                    </div>
                </div>
            </div>
