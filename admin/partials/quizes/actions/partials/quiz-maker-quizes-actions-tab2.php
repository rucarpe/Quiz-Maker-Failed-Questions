        ...
        <div class="col-lg-7 col-sm-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left d-flex">
                    ...
                    <button type="button" style="height:100%;margin-left: 10px;" class="button ays_animate_animation"><?php echo __('Animate!', $this->plugin_name); ?></button>
                </div>
            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    <label for="ays_quiz_navigation_bar_default_type">
                        <?php echo __( 'Navigation bar style', $this->plugin_name ); ?>
                        <a class="ays_help" data-toggle="tooltip" data-html="true" title="<?php echo __( 'Choose the Navigation Bar Styling: Circle or with Border-Radius. By default, the circle styling is chosen for the Navigation Bar.', $this->plugin_name ); ?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </label>
                </div>
                <div class="col-sm-7 ays_divider_left">
                    <label class="ays_quiz_loader" id="ays_quiz_navigation_bar_default_type_box">
                        <input type="radio" id="ays_quiz_navigation_bar_default_type" name="ays_quiz_navigation_bar_type" value="default" <?php echo ($quiz_navigation_bar_type == 'default') ? 'checked' : ''; ?>/>
                        <div class="ays-quiz-questions-nav-item">
                            <a href="javascript:void(0);" class="ays_questions_nav_question" tabindex="0">2</a>
                        </div>
                    </label>
                    <label class="ays_quiz_loader" id="ays_quiz_navigation_bar_square_type_box">
                        <input type="radio" id="ays_quiz_navigation_bar_square_type" name="ays_quiz_navigation_bar_type" value="square" <?php echo ($quiz_navigation_bar_type == 'square') ? 'checked' : ''; ?>/>
                        <div class="ays-quiz-questions-nav-item">
                            <a href="javascript:void(0);" class="ays_questions_nav_question" tabindex="0">2</a>
                        </div>
                    </label>
                </div>
            </div> <!-- Navigation bar style -->
            <hr/>
            <div class="form-group row">
                <div class="col-sm-5">
                    <label>
    ...
    <div class="form-group row">
        <div class="col-lg-7 col-sm-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7 ays_divider_left" >
                    <div class='row ays-answer-view-box' >
                        <div class='col-sm-5'>
                        ...
                        <div class='col-sm-7'>
                            <select name="ays_quiz_grid_view_count" id="ays_quiz_grid_view_count" class="ays-text-input ays-text-input-short ays_quiz_aysDropdown ays-quiz-grid-view-type <?php echo (isset($options['answers_view']) && $options['answers_view'] == 'grid') ? 'selected' : 'display_none'; ?>" style="">
                                <option value="2" <?php echo ($quiz_grid_view_count == '2') ? 'selected' : ''; ?>>2</option>
                                <option value="3" <?php echo ($quiz_grid_view_count == '3') ? 'selected' : ''; ?>>3</option>    
                                <option value="4" <?php echo ($quiz_grid_view_count == '4') ? 'selected' : ''; ?>>4</option>
                            </select>
                        </div>
                    </div>

                    <hr class="ays_separate_view_container-divider  <?php echo (isset($options['answers_view']) && $options['answers_view'] == 'grid') ? '' : 'display_none'; ?>">
                
                    <div class="row ays_separate_view_container <?php echo (isset($options['answers_view']) && $options['answers_view'] == 'grid') ? '' : 'display_none'; ?>" >
                        <div class="col-sm-5">
                            <label for="ays_separate_view">
                                <?php echo __('List view for text answers',$this->plugin_name)?>
                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Enable the toggle and the grid view will refer to only those answers that include images. That means the text answers lacking images will be displayed in the list view.',$this->plugin_name)?>">
                                    <i class="ays_fa ays_fa_info_circle"></i>
                                </a>
                            </label>
                        </div>
                        <div class="col-sm-7 ays_divider_left">
                            <input type="checkbox" value='on' id="ays_separate_view" name="ays_quiz_grid_image_view" class="ays_toggle ays_toggle_slide " <?php echo ($quiz_grid_image_view) ? 'checked': ''; ?> />
                            <label for="ays_separate_view" class="ays_switch_toggle">Toggle</label>
                        </div>
                    </div>
                </div>
            </div> <!-- Answers view -->
