        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select name="ays_paypal_currency" id="ays_paypal_currency" class="ays-text-input ays-text-input-short"
                    ...
                    <option <?php echo ($paypal_currency == 'ILS') ? 'selected' : ''; ?> value="ILS">
                        ILS - <?php echo __( 'Israeli new shekel', $this->plugin_name ); ?></option>
                    <option <?php echo ($paypal_currency == 'SEK') ? 'selected' : ''; ?> value="SEK">
                        SEK - <?php echo __( 'Swedish krona', $this->plugin_name ); ?></option>
                </select>
            </div>
        </div>
        <hr>
            ...
            <div class="col-sm-8">
                <select name="ays_stripe_currency" id="ays_stripe_currency" class="ays-text-input ays-text-input-short"
                    ...
                    <option <?php echo ($stripe_currency == 'pln') ? 'selected' : ''; ?> value="pln">
                        PLN - <?php echo __( 'Polish złoty', $this->plugin_name ); ?></option>
                    <option <?php echo ($stripe_currency == 'ils') ? 'selected' : ''; ?> value="ils">
                        ILS - <?php echo __( 'Israeli new shekel', $this->plugin_name ); ?></option>
                    <option <?php echo ($stripe_currency == 'sek') ? 'selected' : ''; ?> value="sek">
                        SEK - <?php echo __( 'Swedish krona', $this->plugin_name ); ?></option>
                </select>
            </div>
        </div>
        ...
        if (count($zapier) > 0):
            ...
            <?php else: ?>
                ...
                <div id="testZapierFields" class="d-none">
                    ...
                    <input type="checkbox" name="zapierTest[]" value="ays_user_score" data-name="Score" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_quiz_title" data-name="Quiz_title" data-value="<?php echo $quiz_title; ?>" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_quiz_id" data-name="Quiz_ID" data-value="<?php echo isset($id) ? $id : 0; ?>" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_duration" data-name="Duration" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_start_date" data-name="Start_Date" data-value="<?php echo current_time( 'mysql' ); ?>" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_end_date" data-name="End_Date" data-value="<?php echo current_time( 'mysql' ); ?>" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_ip" data-name="ip" data-value="<?php echo Quiz_Maker_Data::get_user_ip(); ?>" checked/>
                    <input type="checkbox" name="zapierTest[]" value="ays_user_id" data-name="User_ID" data-value="<?php echo get_current_user_id(); ?>" checked/>
                    <?php
