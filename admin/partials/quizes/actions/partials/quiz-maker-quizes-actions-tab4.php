<div id="tab4" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab4') ? 'ays-quiz-tab-content-active' : ''; ?>">
    ...
    <div class="form-group row ays_toggle_parent">
        ...
        <div class="col-sm-7 ays_toggle_target ays_divider_left <?php echo $enable_questions_result ? '' : 'display_none'; ?>">
            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    <label for="ays_quiz_show_results_based_pass_score">
                        <?php echo __('Show/hide results based on pass score',$this->plugin_name); ?>
                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __("Enable this checkbox to show/hide the results of the quiz based on whether the user has got the pass score or not. Please note, that if the user hasn't got the passing score, the results will not be displayed on the front-end. For example, if the user received 70/80, then, he/she will not see the results after the quiz.",$this->plugin_name); ?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </label>
                </div>
                <div class="col-sm-8">
                    <input type="checkbox" class="ays-enable-timer1" id="ays_quiz_show_results_based_pass_score" name="ays_quiz_show_results_based_pass_score" value="on" <?php echo ($quiz_show_results_based_pass_score) ? 'checked' : ''; ?> />
                </div>
            </div>
            <hr>
            <div class="form-group row">
                <div class="col-sm-4">
                    <label for="ays_quiz_hide_banner_questions_on_result_page">
                        <?php echo __('Hide the Info Banner Question Text',$this->plugin_name); ?>
                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __("Enable this option to hide the text of the Info Banner question type on the Result page of the quiz.",$this->plugin_name); ?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </label>
                </div>
                <div class="col-sm-8">
                    <input type="checkbox" class="ays-enable-timer1" id="ays_quiz_hide_banner_questions_on_result_page" name="ays_quiz_hide_banner_questions_on_result_page" value="on" <?php echo ($quiz_hide_banner_questions_on_result_page) ? 'checked' : ''; ?> />
                </div>
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-sm-4">
            <label for="ays_checkbox_score_by">
                <?php echo __('Strong calculation of answers score',$this->plugin_name)?>
                <a class="ays_help" data-html="true" data-toggle="tooltip" title="<?php echo "<ul style='list-style-type:disc;padding-left: 20px;'><li>".__("If this option is enabled then our system will calculate answer as 1 or 0.",$this->plugin_name). "</li><li>".__("If the user has one wrong answer he/she will get 0 points.",$this->plugin_name). "</li><li>".__("If the option is disabled, the system will calculate the answer as a percentage.",$this->plugin_name). "</li><li>".__("It means if you answer 2 of 3 correct answers then you will get 2/3 points.",$this->plugin_name)."</li></ul>"; ?>">
                    <i class="ays_fa ays_fa_info_circle"></i>
                </a>
            </label>
        </div>
    ...
    <div class='form-group row ays-field-dashboard ays_toggle_parent'>
        ...
        <div class="col-sm-12 ays_toggle_target <?php echo ($display_score_by == 'by_keywords') ? '' : 'display_none' ?>">
            ...
            <div class="form-group row">
                <div class="col-sm-4">
                    <label for="ays_quiz_show_interval_messages_for_equal_keywords">
                        <?php echo __('Show Interval Messages for equal keywords',$this->plugin_name)?>
                        <a class="ays_help" data-html="true" data-toggle="tooltip" title="<?php echo __("If this option is activated, it will display Interval Messages for all the equal keywords that the user chose at the end of the quiz. Note: If you have activated the Redirect URL, Redirect Sec, or added a WooCommerce product in the Interval Message, only the results of the last keyword will be displayed.",$this->plugin_name); ?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </label>
                </div>
                <div class="col-sm-8">
                    <input type="checkbox" class="ays-enable-timer1" id="ays_quiz_show_interval_messages_for_equal_keywords"
                           name="ays_quiz_show_interval_messages_for_equal_keywords"
                           value="on" <?php echo $quiz_show_interval_messages_for_equal_keywords ? 'checked' : '' ?>/>
                </div>
            </div> <!-- Show interval message -->
            <hr>
            <div class="form-group row">
...
<!--            <tbody>-->
            <?php
                ...
                foreach ($quiz_intervals as $key => $quiz_interval) {
                    ...
                    $interval_messages_email_file = isset($quiz_interval['interval_file']) && $quiz_interval['interval_file'] != "" ? esc_url($quiz_interval['interval_file']) : "";
                    $interval_messages_email_file_name = isset($quiz_interval['interval_file_name']) && $quiz_interval['interval_file_name'] != "" ? esc_attr($quiz_interval['interval_file_name']) : "";
                    $interval_messages_email_file_id   = isset($quiz_interval['interval_file_id']) && $quiz_interval['interval_file_id'] != "" ? esc_attr($quiz_interval['interval_file_id']) : "";
                    $interval_delete_button     = true;
                    $interval_email_button_text = __("Edit file" , $this->plugin_name);
                    if($interval_messages_email_file == "" && $interval_messages_email_file_name == ""){
                        $interval_email_button_text = __("Add file" , $this->plugin_name);
                        $interval_delete_button = false;
                    }
                    ...
                    if (isset($quiz_interval['interval_min']) && !empty($quiz_interval['interval_max']) || isset($quiz_interval['interval_keyword'])) {
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class='intervall-text-section-container'>
                                    <textarea type="text" name="interval_text[]" class="interval_text"><?php echo stripslashes(htmlentities($quiz_interval['interval_text'])) ?></textarea>
                                     <div class="ays-quiz-intervals-img-icon-box">
                                        <div class="ays-quiz-open-intervals-editor " data-container="body" data-toggle="popover" data-trigger="hover" data-placement="auto" data-content="<?php echo __('Open editor',$this->plugin_name); ?>">
                                            <div class="ays-intervals-img-icon-content">
                                                <div class="ays-intervals-img-icon-content-div">
                                                    <div class="ays-quiz-icons">
                                                        <img src="<?php echo AYS_QUIZ_ADMIN_URL; ?>/images/icons/edit-content.svg">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <tr class="ays-interval-hidden-row <?php echo $className; ?>" data-expanded="false">
                                <td colspan="8" class="hiddenRow ays_interval_redirect_td">
                                    ...
                                    <hr>
                                    <div class="ays-quiz-interval-email-message-files-main-contnet">
                                        <div class="ays-quiz-interval-condition-containers-conditions-contents-messages-title">
                                            <p class="ays-subtitle ays-quiz-interval-messages-contnet-titles">
                                                <?php echo __("E-mail Attachment file" , $this->plugin_name); ?>
                                                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Attach a file to the Interval Message. Please note, that the system will send the attachment via email only if the Send interval message to user and the Send Interval message to admin options are enabled for the quiz. If these options are enabled, the corresponding file attachment will be sent to the user when appearing in the particular Interval. Note: The feature will not work if the %%interval_message%% message variable is inserted in the Email Message option and if any of these options is disabled for the quiz.',$this->plugin_name)?>">
                                                    <i class="ays_fa ays_fa_info_circle"></i>
                                                </a>   
                                            </p>
                                        </div>
                                        <hr>
                                        <div class="ays-quiz-interval-email-message-files">
                                            <div>
                                                <button class="button ays-quiz-interval-add-email-message-files" type="button"><?php echo $interval_email_button_text; ?></button>
                                                <input type="hidden" class="ays-quiz-interval-email-message-editor-file" name="interval_messages_email_file[]" value="<?php echo $interval_messages_email_file; ?>" >
                                                <input type="hidden" class="ays-quiz-interval-email-message-editor-file-id" name="interval_messages_email_file_id[]" value="<?php echo $interval_messages_email_file_id; ?>" >
                                            </div>
                                            <div class="ays-quiz-interval-email-message-files-body <?php echo !$interval_delete_button ? "display_none" : "" ?>">
                                                <div class="ays-quiz-interval-email-message-files-content">
                                                    <a href="<?php echo $interval_messages_email_file;?>" download="<?php echo $interval_messages_email_file;?>" class="ays-quiz-interval-email-message-files-content-text"><?php echo $interval_messages_email_file_name; ?></a>
                                                    <input type="hidden" class="ays-quiz-interval-email-message-editor-file-name" name="interval_messages_email_file_name[]" value="<?php echo $interval_messages_email_file_name; ?>" >
                                                </div>
                                            </div>
                                            <div class="ays-quiz-interval-email-message-files-wrapper <?php echo !$interval_delete_button ? "display_none" : "" ?>">
                                                <div class="ays-quiz-interval-email-message-files-wrapper-delete-wrap">
                                                    <div role="button" class="ays-quiz-interval-email-message-files-wrapper-delete-cont ays-quiz-interval-email-message-files-remove removeFile">
                                                        <div class="ays-quiz-interval-icons">
                                                            <img src="<?php echo AYS_QUIZ_ADMIN_URL; ?>/images/remove-normal.png">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!--            </tbody>-->
    ...
    <div class="form-group  ays_toggle_parent">
        ...
        <div class="ays_toggle_target_2 <?php echo $enable_top_keywords ? '' : 'display_none' ?>">
            <div class="col-sm-4">
