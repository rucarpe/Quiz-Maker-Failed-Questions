                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="ays_quiz_loader">
                            ...
                            <span class="form-check-label" for="ays_limit_users_by_ip"><?php echo __('IP',$this->plugin_name)?></span>
                        </label>
                        <label class="ays_quiz_loader">
                            ...
                            <span class="form-check-label" for="ays_limit_users_by_user_id"><?php echo __('User ID',$this->plugin_name)?></span>
                        </label>
                        <label class="ays_quiz_loader">
