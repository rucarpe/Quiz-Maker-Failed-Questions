<div id="tab1" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab1') ? 'ays-quiz-tab-content-active' : ''; ?>">
    ...
    <input type="radio" class="ays-enable-timer1" name="ays_quiz_condition_calculation_type" value="by_category" <?php echo ($quiz_condition_calculation_type == 'by_category') ? 'checked' : ''; ?> style="display: none;"/>
...
-->
    ...
    <div class="ays-field-dashboard ays-table-wrap" style="padding-top: 15px;">
        <table class="ays-questions-table" id="ays-questions-table">
            ...
            <tbody>
            <?php
            if( isset($question_id_array) && !(count($question_id_array) === 1 && $question_id_array[0] == '')  && 1==0) {
