...
$question_default_tags = "";
if( $action == 'add' ){
    $question_default_tags = isset($gen_options['question_default_tags']) && $gen_options['question_default_tags'] != '' ? stripslashes(esc_attr($gen_options['question_default_tags'])) : "";
}
...
//Tag IDs
$question_tag_ids = (isset($question['tag_id']) && $question['tag_id'] != '') ? explode(',',$question['tag_id']) : $question_default_tags;
    ...
    <div class="container-fluid">
        ...
        <form method="post" id="ays-question-form">
            ...
            <div id="tab1" class="ays-quiz-tab-content <?php echo ($ays_question_tab == 'tab1') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <div class="hide_for_custom_type <?php echo ($is_custom_type) ? 'display_none' : ''; ?>">
                    <label class='ays-label' for="ays-answers-table">
                        ...
                        <?php 
                            ...
                            <div class="ays_quiz_small_hint_text_for_message_variables" style="cursor:default;">
                            <?php
                               echo __('Please copy and paste the slugs instead of the missing words in the question textarea.', $this->plugin_name);
                            ?>
                            </div>
                            <?php
                            endif; 
                                ...
                                <?php if ( ! empty( $answer_incorrect_matches ) && is_array( $answer_incorrect_matches ) ): ?>
                                    ...
                                    <tr class="ays-incorrect-match-row">
                                        <td class="ays-quiz-question-answer-incorrect-match-row">
                                            <input type="text" name="ays-answer-incorrect-matches[]" class="ays-incorrect-answer-match-value" value="<?php echo esc_attr( stripslashes($match) ); ?>"/>
                                        </td>
                ...
                <hr class="show_only_for_mixed_types <?php echo ($is_mixed_type) ? '' : 'display_none'; ?>"/>
                <div class="form-group row show_only_for_mixed_types <?php echo ($is_mixed_type) ? '' : 'display_none'; ?>">
                    <div class="col-sm-4">
                        <label for="ays_answers_weight">
                            <?php echo __('Weight/Point', $this->plugin_name); ?>
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the weight/point of the answer. It will be multiplied with the question weight (if you choose quiz calculation by points). The default value is 0.', $this->plugin_name ); ?>">
                                <i class="ays_fa ays_fa_info_circle"></i>
                            </a>
                        </label>
                    </div>
                    <div class="col-sm-8">
                        <input type="text" id="ays_answers_weight" class="ays-text-input ays-text-input-short" name="ays_answers_weight" value="<?php echo $answers_weight; ?>" <?php echo $readonly_option; ?> />
                    </div>
                </div>
                <hr class="hide_for_custom_type <?php echo ($is_custom_type) ? 'display_none' : ''; ?>"/>
            ...
            <div id="tab2" class="ays-quiz-tab-content <?php echo ($ays_question_tab == 'tab2') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <div class="form-group row hide_for_custom_type <?php echo ($is_custom_type) ? 'display_none' : ''; ?>">
                    <div class="col-sm-4">
                        <label for="wrong_answer_text">
                            <?php echo __('Message for the wrong answer ',$this->plugin_name)?>
                ...
                <div class="form-group row hide_for_custom_type <?php echo ($is_custom_type) ? 'display_none' : ''; ?>">
                    <div class="col-sm-4">
                        <label for="right_answer_text">
                            <?php echo __('Message for the right answer ',$this->plugin_name)?>
