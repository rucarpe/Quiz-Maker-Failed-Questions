...
//        }
    ...
    public function add_edit_quiz_attribute( $data ){
        ...
        if( isset($data["quiz_attribute_action"]) && wp_verify_nonce( $data["quiz_attribute_action"],'quiz_attribute_action' ) ){
            ...
            $quiz_attr_file = ! empty($data['ays_quiz_attr_file']) ? $data['ays_quiz_attr_file'] : array(
            ...
            $quiz_attr_file['allow_specific_types'] = (isset($quiz_attr_file['allow_specific_types']) && $quiz_attr_file['allow_specific_types'] == 'on') ? 'on' : 'off';
            $quiz_attr_file['max_size'] = !empty( $quiz_attr_file['max_size'] ) ? $quiz_attr_file['max_size'] : '5';
            $quiz_attr_file['types'] = is_array( $quiz_attr_file['types'] ) && !empty( $quiz_attr_file['types'] ) ? $quiz_attr_file['types'] : array(
                'pdf'   => 'on',
                'docx'  => 'on',
                'png'   => 'on',
                'jpg'   => 'on',
            ...
            $quiz_attr_file['types']['pdf'] = (isset($quiz_attr_file['types']['pdf']) && $quiz_attr_file['types']['pdf'] == 'on') ? 'on' : 'off';
            $quiz_attr_file['types']['docx'] = (isset($quiz_attr_file['types']['docx']) && $quiz_attr_file['types']['docx'] == 'on') ? 'on' : 'off';
            $quiz_attr_file['types']['png'] = (isset($quiz_attr_file['types']['png']) && $quiz_attr_file['types']['png'] == 'on') ? 'on' : 'off';
            $quiz_attr_file['types']['jpg'] = (isset($quiz_attr_file['types']['jpg']) && $quiz_attr_file['types']['jpg'] == 'on') ? 'on' : 'off';
            $quiz_attr_file['types']['gif'] = (isset($quiz_attr_file['types']['gif']) && $quiz_attr_file['types']['gif'] == 'on') ? 'on' : 'off';
            ...
            if( $id == 0 ){
                ...
                $quiz_attribute_insert_id = $wpdb->insert_id;
            ...
            if($id === 0 || is_null($id)){
                $attribute_id = $quiz_attribute_insert_id;
            }else{
                $attribute_id = $id;
            }
