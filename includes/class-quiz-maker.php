	...
	private function define_admin_hooks() {
        ...
        if( isset($_GET["page"]) && sanitize_key($_GET["page"]) != ""){
        	...
        	if( $if_plugin_screen_page !== false && ( $if_plugin_screen_page === 0 || $if_plugin_screen_page >= 0) ){
        		// $this->loader->add_action('admin_notices', $plugin_admin, 'ays_quiz_business_popup_box_top_banner', 1);

        		// $this->loader->add_action('admin_footer', $plugin_admin, 'ays_quiz_business_popup_box_banner', 1);
        	}
        }
	}
...
//		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
        ...
        $this->loader->add_action( 'wp_ajax_ays_quiz_attr_upload_file', $plugin_public, 'ays_quiz_attr_upload_file' );
        $this->loader->add_action( 'wp_ajax_nopriv_ays_quiz_attr_upload_file', $plugin_public, 'ays_quiz_attr_upload_file' );
	...
	private function define_integrations_hooks() {
		...
		// $this->loader->add_filter( 'ays_qm_settings_page_integrations_contents', $plugin_integrations, 'ays_settings_page_recaptcha_content_pro', 15, 2 );
